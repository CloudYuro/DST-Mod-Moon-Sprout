...
local shadow_tags = {"nightmarecreature", "shadowcreature", "shadow", "shadowminion", "stalker", "stalkerminion", "nightmare", "shadow_fire", "shadow_aligned"}
...
local function fn()
	...
	inst:ListenForEvent("timerdone", function(inst, data)
		if data.name == "expire" then
			...
			inst:DoTaskInTime(inst.AnimState:GetCurrentAnimationLength(), function() inst:Remove() end)
		end
	end)
...
return Prefab("wormwood_gestalt_guard", fn, assets, prefabs)
