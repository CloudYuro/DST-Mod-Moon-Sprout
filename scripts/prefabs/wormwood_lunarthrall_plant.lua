...
local TARGET_CANT_TAGS = {  "character", "INLIMBO", "lunarthrall_plant", "lunarthrall_plant_end", "wormwood_pet" }
    ...
    if not inst.no_targeting then
        local target = FindEntity(
            ...
            function(guy)
                ...
                if guy.components.follower and guy.components.follower:GetLeader() and guy.components.follower:GetLeader():HasTag("player") then
                    return nil  -- 排除被玩家领导的生物
                end
