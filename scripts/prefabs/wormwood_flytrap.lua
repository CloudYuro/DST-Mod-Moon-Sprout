...
local function GenerateTuningValues()
    ...
    for i = 3, max_level do
        ...
        tuning[string.format("FLYTRAP_%d_SPEED", i)] = 3  -- 速度保持不变
        tuning[string.format("FLYTRAP_%d_ATTACK_PERIOD", i)] = 3  -- 攻击间隔保持不变
